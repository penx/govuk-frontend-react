...
// TODO:
// - {{ params.containerClasses | default('govuk-width-container') }}"
// - svg fallback image
// composes for modifiers

const Header = ({
  className, productName, serviceName, navigation, serviceUrl, ...props
}) => (
  <header
  ...
  >
    <div className={styles['govuk-header__container']}>
      <div className={styles['govuk-header__logo']}>
        <a href="TODO:" className={styles['govuk-header__link--homepage']}>
