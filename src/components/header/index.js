      ...
      >
        <div className={cx(styles['govuk-header__container'], containerClasses)}>
          <div className={styles['govuk-header__logo']}>
            <HomepageLink
              href={homepageUrl}
              className={styles['govuk-header__link--homepage']}
              {...homepageProps}
            >
              <span className={styles['govuk-header__logotype']}>
                ...
                <span className={styles['govuk-header__logotype-text']}>GOV.UK</span>
              </span>
              {productName && (
                <span className={styles['govuk-header__product-name']}>{productName}</span>
              )}
            </HomepageLink>
          </div>
